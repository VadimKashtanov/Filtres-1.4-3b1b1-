...
void cree_lstm1d_b8(Mdl_t * mdl, uint inst);
...
void nvidia_lstm1d_b8_naive(			//mode = 1
	uint X_vars, uint Y_vars,
	uint X, uint Y,
	uint t,
	uint DEPART_x,
...
void nvidia_lstm1d_b8__shared(			//mode = 2
	uint X_vars, uint Y_vars,
	uint X, uint Y,
	uint t,
	uint DEPART_x,
...
void d_nvidia_lstm1d_b8_naive(			//mode = 1
	uint X_vars, uint Y_vars,
	uint X, uint Y,
	uint t,
	uint DEPART_x,
